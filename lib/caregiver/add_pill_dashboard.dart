...
class _AlarmScreenState extends State<AlarmScreen> {
  ...
  Future<void> _fetchMedicineNames() async {
    try {
      final response = await http.get(Uri.parse('http://192.168.1.5/alarm/pill_api/get_pill.php'));
  ...
  Future<void> _fetchPatientNames() async {
    try {
      final response = await http.get(Uri.parse('http://192.168.1.5/alarm/patient_api/get_patient.php'));
      if (response.statusCode == 200) {
        final List<dynamic> data = json.decode(response.body);
        setState(() {
  ...
  Future<void> _submitData() async {
    ...
    final uri = Uri.parse('http://192.168.1.5/alarm/alarm_api/alarm_api.php');
