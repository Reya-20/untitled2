...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _fetchAlarmData() async {
    String url = 'http://192.168.1.5/alarm/alarm_api/getalarm.php'; // Ensure the correct URL
  ...
  Future<void> _updateAlarmStatusToMissed(int alarmId) async {
    try {
      final response = await http.put(
        Uri.parse('http://192.168.1.5/alarm/alarm_api/alarm_update_missed.php'), // Ensure this URL is correct
  ...
  Future<void> _updateAlarmStatus(int alarmId) async {
    try {
      final response = await http.put(
        Uri.parse('http://192.168.1.5/alarm/alarm_api/alarm_update.php'), // Ensure this URL is correct
